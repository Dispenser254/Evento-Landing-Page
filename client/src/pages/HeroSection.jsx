function HeroSection() {
  return (
    <section className="bg-gray-700 bg-[url('https://i.ibb.co/8Dw3HDN/conference.jpg')] bg-center bg-no-repeat bg-blend-multiply mt-6 h-screen">
      <div className="mx-auto max-w-screen-xl px-4 py-24 text-center lg:py-56">
        ...
        <p className="mb-8 text-lg font-normal text-gray-300 sm:px-16 lg:px-48 lg:text-xl">
          Join us for an exciting journey into the world of web development,
          where we believe in harnessing the boundless potential of innovation,
